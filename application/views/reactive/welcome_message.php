...
<head>
    ...
    <title>Reactive - Free HTML5 Template by templatemo</title>
...
<div id="templatemo_banner_top" class="container_wapper">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <p><a href="#">Reactive</a> | <a href="#">Responsive Bootstrap Template</a></p>
            </div>
            <div class="col-md-4">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-md-8 col-md-offset-4">
                ...
                <h1><a href="#">Reactive</a></h1><br /><br /><br />
    ...
    <ul>
        <li class="templatemo_banner_slide_01">
            <div class="slide_caption">
                ...
                <p>Aenean diam libero, venenatis eu risus eu, tincidunt porttitor orci. Nulla consequat mi et lectus vehicula condimentum. Nulla ullamcorper dolor vehicula dolor interdum, eget fermentum ligula bibendum. Lorem iscup agur condimentum rhoncus. Alam so ur velit. Pellentesque luctus ac nunc er hendrerit.</p>
            </div>
        </li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-md-offset-3 col-md-offset-3">
                <p>Reactive is <a href="#">free HTML5 template</a> based on Bootstrap responsive framework. This template features <a rel="nofollow" href="http://www.pixedelic.com/plugins/camera/">Camera Slideshow</a> for the image slider. Credit goes to <a rel="nofollow" href="http://unsplash.com">Unsplash</a> for photos used in this template. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit.</p>
            </div>
...
<div id="templatemo_footer" class="container_wapper">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <p>Copyright © <?php echo date('Y');?> Company Name <!-- Credit: www.templatemo.com --></p>
            </div>
        </div>
    </div>
...
<!--
Reactive Template
http://www.templatemo.com/preview/templatemo_404_reactive
-->
</body>
</html>