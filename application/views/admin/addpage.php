<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1>Add New Page <small>Jenkins Page Editor</small></h1>
            <ol class="breadcrumb">
                ...
                <li class="active"><i class="fa fa-edit"></i> Add Page</li>
            </ol>
            <div id="result"></div>
            ...
            <form class="form-horizontal" role="form" method="post" id="pagesform">
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="pagetitle" name="pagetitle" placeholder="Title" />
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-sm-2 control-label">Url:</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="pageurl" name="pageurl" placeholder="Url" />
                        </div>
                    </div>
                    <div class="row">
