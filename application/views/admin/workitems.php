<div id="page-wrapper">
    ...
    <?php foreach($workitems as $workitem):?>
        <div class="row" style="padding: 3px;">
            <div class="col-lg-12">
                <div class="col-md-5"><a href="/manage/salescontent/<?php echo $workitem['workid'];?>"><button class="btn btn-default"><li class="fa fa-pencil"></li> <?php echo $workitem['workentry'];?></button></a> </div>
